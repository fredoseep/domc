...
public class TameNautilusGoal extends TameAnimalGoal implements TextureProvider {
   private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("draftout", "textures/custom/tame/tame_nautilus.png");
   ...
   static {
      TYPES = List.of(EntityType.NAUTILUS);
   }
}
