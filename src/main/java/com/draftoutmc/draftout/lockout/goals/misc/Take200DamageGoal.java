...
public class Take200DamageGoal extends Goal implements TextureProvider, CustomTextureRenderer, HasTooltipInfo {
   private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("draftout", "textures/custom/take_200_damage.png");
   ...
   public boolean renderTexture(GuiGraphicsExtractor context, int x, int y, int tick) {
      ...
      Utility.drawStackCount(context, x, y, "200");
      return true;
   }

   public List<String> getTooltip(LockoutTeam team, Player player) {
      List<String> tooltip = new ArrayList();
      double damage = (Double)LockoutMatchData.getLockout().damageTaken.getOrDefault(team, (double)0.0F);
      tooltip.add(" ");
