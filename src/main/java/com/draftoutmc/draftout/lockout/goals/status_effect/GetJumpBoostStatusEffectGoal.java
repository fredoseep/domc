...
public class GetJumpBoostStatusEffectGoal extends StatusEffectGoal implements TextureProvider {
   private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("draftout", "textures/custom/status_effect/jump_boost.png");
   ...
   public MobEffect getStatusEffect() {
      return (MobEffect)MobEffects.JUMP_BOOST.value();
   }
