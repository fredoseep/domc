...
public class GetMiningFatigueStatusEffectGoal extends StatusEffectGoal implements TextureProvider {
   private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("draftout", "textures/custom/status_effect/mining_fatigue.png");
   ...
   public MobEffect getStatusEffect() {
      return (MobEffect)MobEffects.MINING_FATIGUE.value();
   }
